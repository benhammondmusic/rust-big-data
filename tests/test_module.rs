...
mod tests {
    ...
    fn test_compare_new_rust_results_to_old_python_golden_data() {
        ...
        let prod_sex_state = "tests/prod_data/cdc_restricted_by_sex_state.csv";
        ...
        let expected_by_sex_python_lf = LazyCsvReader::new(prod_sex_state)
            .has_header(true)
            .finish()
            .expect("Failed to read CSV file: prod_sex_state");
